    ...
    override class func spec() {
        ...
        describe("creating custom events") {
            it("creates basic events as expected") {
                let event = Event(user: StatsigUser(userID: ""), name: "purchase", disableCurrentVCLogging: false)
            ...
            it("creates events with value and metadata as expected") {
                let event = Event(user: StatsigUser(userID: ""), name: "purchase", value: 1.23,
