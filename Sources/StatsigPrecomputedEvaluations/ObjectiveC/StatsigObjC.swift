...
public final class StatsigObjC: NSObject {
    ...
    @objc public static func start(withSDKKey: String, user: StatsigUser) {
        Statsig.start(sdkKey: withSDKKey, user: user)
    }
    ...
    @objc public static func start(withSDKKey: String, user: StatsigUser, completion: completionBlock) {
        Statsig.start(sdkKey: withSDKKey, user: user, completion: completion)
    }

    @objc public static func start(withSDKKey: String, user: StatsigUser, options: StatsigOptionsObjC) {
        Statsig.start(sdkKey: withSDKKey, user: user, options: options.optionsInternal)
    }
    ...
    {
        Statsig.start(sdkKey: withSDKKey, user: user, options: options.optionsInternal, completion: completion)
    }
    ...
    @objc public static func updateUser(newUser: StatsigUser) {
        Statsig.updateUser(newUser, completion: nil)
    }

    @objc public static func updateUser(newUser: StatsigUser, completion: completionBlock) {
        Statsig.updateUser(newUser, completion: completion)
    }
